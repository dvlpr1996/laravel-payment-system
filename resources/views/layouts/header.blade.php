...
<head>
		...
		<meta name="keywords" content="Laravel Payment System, dvlpr1996,laravel,php,alpine.js,tailwind">
		<meta name="description" content="Laravel Payment System">
...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)));" class="max-w-7xl mx-auto px-4">
